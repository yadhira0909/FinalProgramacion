...
namespace FinalProgramacion.Controllers
{
    public class SalidasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "empleado,tipo_Salida,motivo,comentario")] Salida salida)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "empleado,tipo_Salida,motivo,comentario")] Salida salida)
        {
            if (ModelState.IsValid)
            {
