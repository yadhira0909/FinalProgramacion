...
namespace FinalProgramacion.Controllers
{
    public class PermisosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "empleado,desde,hasta,comentarios")] Permisos permisos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "empleado,desde,hasta,comentarios")] Permisos permisos)
        {
            if (ModelState.IsValid)
            {
